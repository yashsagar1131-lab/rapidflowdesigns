    ...
    <footer className="py-12">
      <div className="mx-auto flex max-w-content flex-col gap-6 px-6 md:flex-row md:items-center md:justify-between md:px-10">
        <div>
          ...
          <p className="text-[13px] text-paper-mute">From Concept to Manufacturable PCB.</p>
        </div>

        <div className="flex flex-col gap-1 md:items-end">
          <a href="mailto:yash@rapidflowdesigns.com" className="text-[13px] text-paper-dim transition-colors hover:text-copper">
